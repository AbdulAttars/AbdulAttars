...
export default async function handler(request, response) {
  ...
  try {
    ...
    const sessionParams = {
      ...
      payment_intent_data: { metadata: { order_code: orderCode } },
    ...
    const clientError = /required|invalid|unknown|sold out|cart|quantity|choose|address|cross-origin/i.test(message);
